...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!project) {
    return {
      title: 'Case Study Not Found - Kryohm',
      description: 'The requested case study could not be found.'
    }
  }

  return {
    title: `${project.title} - Case Study | Kryohm IoT Solutions`,
    description: project.excerpt,
    keywords: `${project.industry}, ${project.productType}, IoT case study, ${project.tags.join(', ')}, implementation, results`,
    openGraph: {
      title: project.title,
      description: project.excerpt,
      type: 'article',
